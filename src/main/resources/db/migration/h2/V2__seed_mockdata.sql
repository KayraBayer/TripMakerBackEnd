MERGE INTO city (name, center_lat, center_lng) KEY(name) VALUES
  ('Milano', 45.4642, 9.19),
...
-- Milano
MERGE INTO place (external_id, city_name, category, name, description, lat, lng)
KEY(external_id, city_name, category)
VALUES
